...
const RespondToQuestion: React.FC<RespondToQuestionProps> = ({
    questions,
    onRecordingComplete,
    onSubmit,
}) => {
                    ...
                    <View style={styles.transcriptContent}>
                        {currentQuestion?.content && (
                            <View style={styles.transcriptItem}>
                                ...
                                <Text style={styles.transcriptSectionText}>{currentQuestion.content}</Text>
                            </View>
                        )}
                        {currentQuestion?.directions && (
                            <View style={styles.transcriptItem}>
                                <Text style={styles.transcriptSectionTitle}>Directions:</Text>
                                <Text style={styles.transcriptSectionText}>{currentQuestion.directions}</Text>
                            </View>
                        )}
                        {currentQuestion?.questionText && (
                            <View style={styles.transcriptItem}>
                                <Text style={styles.transcriptSectionTitle}>Question:</Text>
                                <Text style={styles.transcriptSectionText}>{currentQuestion.questionText}</Text>
                            </View>
                        )}
                    </View>
                )}
