...
interface ReadAloudSpeakingProps {
    text: string;
...
const ReadAloudSpeaking: React.FC<ReadAloudSpeakingProps> = ({
    text,
    preparationTime = 45,
    speakingTime = 45,
    onRecordingComplete,
    ...
    const renderTextToRead = () => (
        ...
        >
            {phase === 'instruction' && (
                <View style={styles.instructionTextHeader}>
                    <Text style={styles.instructionHeaderText}>Text to Read:</Text>
                </View>
            )}
            <Text style={styles.textToRead}>{text}</Text>
        </ScrollView>
    );
...
export default ReadAloudSpeaking;