...
import { AnswerResult, GrammarFormulaItem } from "@/types/type-exercise";
import { cn } from "@/utils";


interface GrammarFormulaProps {
  item: GrammarFormulaItem;
  onAnswer: (result: AnswerResult) => void;
}

export function GrammarFormula({ item, onAnswer }: GrammarFormulaProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl ring-1 ring-slate-200">
        <p className="text-lg text-slate-900 leading-relaxed">{item.prompt}</p>
      </div>
