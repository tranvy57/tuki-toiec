      ...
      <div className="relative max-w-7xl mx-auto px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-12">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="/60 hover:text-pink-200 transition-all text-sm font-light inline-block hover:translate-x-2 duration-300 relative group"
                  >
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="/60 hover:text-purple-200 transition-all text-sm font-light inline-block hover:translate-x-2 duration-300 relative group"
                  >
                    <span className="relative z-10">{item.name}</span>
                    <span className="absolute inset-0 scale-0 group-hover:scale-100 bg-white/5 rounded-md transition-transform duration-300 -z-0 -m-1 p-1"></span>
                  </Link>
          ...
          <div className="space-y-8">
            <div>
              <h3 className=" font-bold text-base tracking-wide mb-6">
            ...
            <div>
              <h4 className=" font-bold text-base tracking-wide mb-3">
                Đăng ký nhận tin
              </h4>
              <p className="text-xs /60 mb-4 font-light leading-relaxed">
              ...
              <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                <Input
                  ...
                  className="w-full bg-white/10 border-white/20  placeholder:/50 focus:border-pink-400 focus:ring-pink-400/20 rounded-xl text-sm h-12 backdrop-blur-sm font-light"
                  required
                />
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-pink-300 to-primary hover:from-pink-300  hover:to-pink-400  shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 transition-all duration-300 rounded-xl h-12 font-medium hover:scale-[1.02] border border-white/10"
                >
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              <p className="text-sm /60 font-light">
                © {new Date().getFullYear()} Tuki TOEIC. Tất cả quyền được bảo
                lưu.
              </p>
              <p className="text-xs /40 mt-1 font-light">
                Developed with ❤️ for TOEIC learners in Vietnam
              </p>
            </div>
            <div className="flex items-center gap-8 text-sm /60">
              <Link
                href="/privacy"
