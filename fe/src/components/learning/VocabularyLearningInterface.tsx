...
export default function VocabularyLearningInterface({
  ...
  const [currentView, setCurrentView] = useState<"overview" | "learning">(
    "overview"
  );
      ...
      <div className="max-w-4xl mx-auto p-6 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Chưa có từ vựng nào để học trong bài này.
          </p>
          {onBack && (
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-8">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Nâng cao vốn từ vựng với phương pháp flashcard và quiz tương tác. Hệ
            thống sẽ theo dõi tiến độ và điều chỉnh độ khó phù hợp.
          </p>
        </motion.div>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <h3 className="text-2xl font-bold text-slate-900">
                {
                  vocabularies.filter(
                    (v) => v.audioUrl || v.pronunciation !== "/pronunciation/"
                  ).length
                }
              </h3>
        ...
        >
          <Card className="group cursor-pointer transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <CardContent>
              <p className="text-slate-600 mb-4">
                Học từ vựng với thẻ từ tương tác. Xem từ, nghĩa, phiên âm và ví
                dụ. Phương pháp hiệu quả để ghi nhớ từ mới.
              </p>
          ...
          <Card className="group cursor-pointer transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <CardContent>
              <p className="text-slate-600 mb-4">
                Kiểm tra kiến thức với trắc nghiệm, điền từ và nghe âm thanh. AI
                tự động chọn dạng bài phù hợp dựa trên dữ liệu từ vựng.
              </p>
              <div className="flex items-center text-sm text-slate-500 mb-4">
                <CheckCircle2 className="w-4 h-4 mr-2 text-green-500" />
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="text-center">
                      <Badge variant="outline" className="mb-4">
                        {currentQuizType === "mcq" && "📝 Trắc nghiệm"}
                        {currentQuizType === "cloze" && "✏️ Điền từ"}
                    ...
                    <div className="flex gap-3">
                      {isAnswerCorrect === null ? (
                        ...
                        >
                          {session.currentIndex === session.totalItems - 1
                            ? "Hoàn thành"
                            : "Tiếp tục"}
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 flex items-center justify-center min-h-[400px]">
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-4">
          Không thể tải nội dung học từ vựng.
        </p>
        {onBack && (
          <Button onClick={onBack}>
            <ArrowLeft className="w-4 h-4 mr-2" />
