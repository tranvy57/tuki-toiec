...
const rainbowButtonVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        primary:
          "relative border-0 text-white font-semibold shadow-sm \
 bg-[linear-gradient(var(--primary),var(--primary)),linear-gradient(var(--color-6),var(--color-6),rgba(18,18,19,0)),linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] \
 bg-[length:200%] text-primary-foreground \
 ...
 before:animate-rainbow before:bg-[linear-gradient(90deg,var(--color-1),var(--color-5),var(--color-3),var(--color-4),var(--color-2))] \
 ...
 transition transform duration-150 active:scale-[0.96] active:before:opacity-60 active:shadow-inner",
        default:
        ...
        outline:
          "relative border border-input border-b-transparent \
 ...
 bg-[length:200%] text-accent-foreground \
 [background-clip:padding-box,border-box,border-box] [background-origin:border-box] \
 [border:calc(0.125rem)_solid_transparent] \
