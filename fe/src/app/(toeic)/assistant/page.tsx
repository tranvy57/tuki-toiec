...
import { useChatMessage, generateChatId, getUserId } from "@/api/useChat";
    ...
    <div className="flex items-center justify-center gap-1 h-8 px-4">
      {Array.from({ length: bars }, (_, i) => {
        ...
        const height = isActive
          ? Math.max(0.1, volume + Math.sin(Date.now() * 0.01 + delay) * 0.2)
          : 0.1;
...
export default function VoiceChatPage() {
  ...
  useEffect(() => {
    const greetingText =
      "Hello! I'm Tuki AI, your voice chat assistant. Feel free to speak to me or type your message. How can I help you today?";
                  ...
                  <div className="mt-4 border-gray-200">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className="text-xs text-gray-500 mb-1.5 block">
                            Volume (Text): {Math.round(speechVolume * 100)}%
                          </label>
                          <Slider
                            value={[speechVolume]}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="bg-gray-100 rounded-2xl p-3 border border-neutral-200">
                        <div className="flex gap-1">
                          ...
                          <Circle
                            className="w-2 h-2 fill-purple-600 text-purple-600 animate-bounce"
